                                    ...
                                    <div className="seat">
                                        <div className="seat-choosing">
                                            ...
                                            <div className="pannel-wrapper">
                                                {
                                                    seats.map(seat => (
                                                        <div className={itemChoosing == seat.id && itemAvailable.includes(seat.id) ? "item-seat active" : (itemAvailable.includes(seat.id) ? "item-seat" : "item-seat non-ava")}
                                    ...
                                    <div className="pickup-dropoff__main__choosing">
                                        <div className="pickup-point">
                                            ...
                                            <ul className="pickup-point__content">
                                                {getOn.map(element => (
                                                    <li>
                                                        <input type="radio" name="getOn" value={element.location} onChange={getOnCLick} checked={on == element.location ? true : false} />
                                        ...
                                        <div className="dropoff-point">
                                            ...
                                            <ul className="pickup-point__content">
                                                {getOff.map(element => (
                                                    <li>
                                                        <input type="radio" name="getOff" value={element.location} onChange={getOffCLick} checked={off == element.location ? true : false} />
                                                        <span className="content-locate"> {element.location}</span>
                                                    </li>
                                                ))}
                                            </ul>
