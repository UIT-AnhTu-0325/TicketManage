    ...
    <div>
      ...
      >
        <div className="modal-auth__container js-modal-auth__container">
          <div
            className="modal-auth__close js-closemodal-btn"
            onClick={props.close}
          >
          ...
          <div
            className={auth === 1 ? "auth__content active" : "auth__content"}
          >
            <div className="auth__content__welcome">
              <h3>Welcome Back!</h3>
              <p>
                Chưa có tài khoản?{" "}
                <a href="#" onClick={() => setAuth(2)}>
                  Đăng ký
                </a>
              </p>
            </div>
            ...
            <div className="auth__other-method">
              <p className="text">hoặc đăng nhập với</p>
          ...
          <div
            className={auth === 2 ? "auth__content active" : "auth__content"}
          >
